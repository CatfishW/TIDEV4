...
def main(args):
    cfg = LazyConfig.load('./projects/ovdino/configs/ovdino_swin_tiny224_bert_base_infer_demo.py')
    ...
    if args.eval_only:
        ...
        DetectionCheckpointer(model).load('/root/workspace/ZladWu/OV-DINO/ovdino/ovdino_swint_ogc-coco50.2_lvismv40.1_lvis32.9.pth')
